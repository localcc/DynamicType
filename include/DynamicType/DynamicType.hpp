#pragma once
/**
 * Dynamically sized type library
 *
 * This library allows for comfortable creation and usage of types that change their size at runtime
 */
...
#include <DynamicType/TOption.hpp>
